...
func TestReportNewTotalCustomersByStatusWithOptionalParams(t *testing.T) {
	...
	_, err := client.Reports.NewTotalCustomersByStatus(context.TODO(), straddle.ReportNewTotalCustomersByStatusParams{
